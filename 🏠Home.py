...
with col1:
    ...
    html_code = """
    <div style="background-color:#4169E1; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 10px; text-align:center; color: white; width: 100%;">
