...
with col1:
    ...
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EC%83%9D%EA%B0%81AI')
...
with col2:
    ...
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EC%83%9D%EA%B0%81+(%EC%83%9D%EA%B0%81%EC%9D%98_%ED%9E%98)')
    st.markdown(img_html, unsafe_allow_html=True)
...
with col3:
    st.markdown('<div style="background-color:#5A9BD5; padding: 10px; border-radius: 10px; text-align:center;">', unsafe_allow_html=True)
    st.markdown('<h3 style="text-align:center;">생각+</h3>', unsafe_allow_html=True)
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EC%83%9D%EA%B0%81+(%EC%9D%B4%EB%AF%B8%EC%A7%80_%EC%83%9D%EC%84%B1)')
    st.markdown(img_html, unsafe_allow_html=True)
...
with col4:
    ...
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EB%A7%88%EC%9D%8CAI')
    st.markdown(img_html, unsafe_allow_html=True)
...
with col5:
    ...
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EB%A7%88%EC%9D%8C+(%EB%B0%B0%EC%9A%B0%EA%B3%A0_%EC%8B%B6%EC%9D%80%EC%A0%90)')
    st.markdown(img_html, unsafe_allow_html=True)
...
with col6:
    ...
    st.markdown('<h3 style="text-align:center;">마음+</h3>', unsafe_allow_html=True)
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EB%A7%88%EC%9D%8C+(%EC%A7%A7%EC%9D%80%EB%AC%B8%EC%9E%A5)')
    st.markdown(img_html, unsafe_allow_html=True)
...
with col7:
    ...
    st.markdown('<h3 style="text-align:center;">마음+</h3>', unsafe_allow_html=True)
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EB%A7%88%EC%9D%8C+(%EB%85%B8%EB%9E%98_%EB%A7%8C%EB%93%A4%EA%B8%B0)')
    st.markdown(img_html, unsafe_allow_html=True)
...
with col8:
    ...
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EC%8B%A4%EC%B2%9CAI')
    st.markdown(img_html, unsafe_allow_html=True)
...
with col9:
    ...
    img_html = image_to_html('/mnt/data/image.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/%EC%8B%A4%EC%B2%9C+(%EA%B3%84%ED%9A%8D%EC%84%B8%EC%9A%B0%EA%B8%B0)')
    st.markdown(img_html, unsafe_allow_html=True)
