...
with col1:
    ...
    img_html = image_to_html('images/생각이.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/생각AI')
...
with col2:
    ...
    img_html = image_to_html('images/상황생각하기.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/생각AI')
    st.markdown(img_html, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
...
with col4:
    ...
    img_html = image_to_html('images/마음이.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/생각AI')
    st.markdown(img_html, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
...
with col6:
    ...
    img_html = image_to_html('images/마음문장만들기.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/생각AI')
    st.markdown(img_html, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
...
with col7:
    ...
    img_html = image_to_html('images/가사추천하기.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/생각AI')
    st.markdown(img_html, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
...
with col10:
    ...
    img_html = image_to_html('images/실천의지키우기.png', 'https://2gaeyouhl8fwhqotlwa9uz.streamlit.app/생각AI')
    st.markdown(img_html, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
