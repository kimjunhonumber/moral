...
questions = [
    "11111. 모둠 활동을 할 때에는 나의 역할에만 신경 쓰는 것이 좋다.",
    "2. 내가 불편하지 않다면 다른 친구들이 하고 싶은 대로 하는 것이 마음이 편하다.",
    "3. 나는 내가 옳다고 생각하면 내 입장을 강하게 주장한다.",
    "4. 다른 사람과 무언가를 함께 할 때는 갈등이 생길 수밖에 없다.",
    "5. 나는 다른 친구들의 의견을 들을 때, 새로운 것을 더 배운다.",
    "6. 새롭게 해결책을 찾기보다는 내가 해야 할 일에 집중하는 것이 더 낫다.",
    "7. 아무도 내 의견에는 흥미가 없다.",
    "8. 내가 잘 모를 때에는 잘 아는 친구의 의견을 듣는 것이 좋다.",
    "9. 내 의견을 주장하는 것보다 친구들과 사이좋게 잘 지내는 것이 더 중요하다.",
    "10. 친구들이 나에게 관심을 두게 하려면 내 의견을 분명히 이야기해야 한다."
]
